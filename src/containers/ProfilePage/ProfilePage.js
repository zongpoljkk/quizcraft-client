  ...
  return !user_info ? (
    ...
    <Container height={screen_height - NAVBAR_HEIGHT - CONTAINER_PADDING}>
      <ContentContainer>
        ...
        <InfoContainer>
          <Subheader>
            ชื่อ : {user_info.firstname} {user_info.lastname}
          </Subheader>
          {user_info.school && (
        ...
        <LevelContainer>
          {user_info.rank === RANK.BRONZE && <img src={bronze} height={44} />}
          {user_info.rank === RANK.SILVER && <img src={silver} height={44} />}
          {user_info.rank === RANK.GOLD && <img src={gold} height={44} />}
        ...
        <ItemContainer
          ...
          justifyContent={
            user_info.itemInfos.length * ITEM_SIZE <=
        ...
        >
          {user_info.itemInfos?.map((item, index) => (
            <div
              ...
              style={{
                marginRight:
                  index === user_info.itemInfos.length - 1 ? null : 16,
              }}
            >
